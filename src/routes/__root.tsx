  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">
          حدث خلل مؤقت. أعد المحاولة، وإن تكرّر تواصل معنا وسنساعدك.
        </p>
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a
            href="/"
            className="inline-flex items-center justify-center rounded-md border border-input bg-background px-4 py-2 text-sm font-medium hover:bg-accent-tint"
          >
            الرئيسية
          </a>
        </div>
...
function FloatingWhatsApp() {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 inset-s-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-[0_4px_24px_rgba(37,211,102,0.45)] transition-transform duration-200 hover:scale-110 hover:shadow-[0_6px_32px_rgba(37,211,102,0.60)]"
    >
